...
@WebServlet("/EditPTSer")
public class EditPTSer extends HttpServlet {
...
request.setAttribute("Phutung", product);
request.getRequestDispatcher("/EditPT.jsp").forward(request, 
response);
}
/**
...
request.setCharacterEncoding("utf-8");
 ...
 DbUtils.updatephutung(conn, pro); 
